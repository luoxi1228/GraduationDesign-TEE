...
# 设置应用程序的编译标志
App_C_Flags := -fPIC -Wno-attributes $(App_Include_Paths)-fopenmp -lcrypto
...
App_Link_Flags := -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -lpthread -lpbc -lgmp -fopenmp  -lsgx_urts -lmicrohttpd -lcpprest -lboost_system -lssl -lcrypto 
...
Enclave_Link_Flags := $(Enclave_Security_Link_Flags) \
	...
	-Wl,--start-group -L/opt/gmp/6.1.2/lib/ -lsgx_tgmp -L/usr/local/lib64/ -lsgx_tpbc -lsgx_tstdc -lsgx_tcxx -l$(Crypto_Library_Name) -l$(Service_Library_Name) -Wl,--end-group \
